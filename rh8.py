...
style.configure("TEntry", padding=5, relief="flat", font=("Helvetica", 10))
style.configure("TButton", padding=5, relief="flat", font=("Helvetica", 10))
style.configure("Treeview", font=("Helvetica", 10), background="#F1F8E9", fieldbackground="#F1F8E9", rowheight=25)
...
for i, label in enumerate(labels):
    ttk.Label(frame_form, text=label, anchor=tk.W).grid(row=i//4, column=i%4*2, padx=5, pady=5, sticky=tk.W)
...
ttk.Button(frame_buttons, text="Adicionar", command=add_person).grid(row=0, column=0, padx=5, pady=5)
ttk.Button(frame_buttons, text="Alterar", command=update_person).grid(row=0, column=1, padx=5, pady=5)
ttk.Button(frame_buttons, text="Excluir", command=delete_person).grid(row=0, column=2, padx=5, pady=5)
ttk.Button(frame_buttons, text="Exportar para Excel", command=export_to_excel).grid(row=0, column=3, padx=5, pady=5)
...
for label in labels:
    ...
    listbox_people.column(label, width=100)
