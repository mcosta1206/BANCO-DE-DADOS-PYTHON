...
root.configure(bg="#E8F0F2")  # Fundo azul claro

# Estilo TTK
style = ttk.Style(root)
style.theme_use("clam")

style.configure("TLabel", background="#E8F0F2", font=("Arial", 10))
style.configure("TEntry", padding=5, relief="flat", font=("Arial", 10))
style.configure("TButton", padding=5, relief="flat", font=("Arial", 10), background="#007BFF", foreground="white")
style.map("TButton", background=[('active', '#0056b3')])
style.configure("Treeview", font=("Arial", 10), background="#FFFFFF", fieldbackground="#FFFFFF", rowheight=30)
...
for label in labels:
    ...
    listbox_people.column(label, width=130)
